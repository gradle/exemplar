...
[source,java]
----
include::../sample-check/src/test/java/org/gradle/samples/test/runner/CliSamplesRunnerIntegrationTest.java[tags=source]
----
...
[source,java]
----
include::../sample-check/src/test/java/org/gradle/samples/test/runner/GradleSamplesRunnerIntegrationTest.java[tags=sample-output-normalizers]
----
